...
def gemini_audit_one(mp4: Path) -> dict:
    ...
    audit_script = PROJECT_ROOT / ".claude" / "skills" / "saraandeva-episode" / "scripts" / "pipeline" / "auditClipsWithGemini.py"
    r = subprocess.run(
...
def main():
    ...
    sheet_script = PROJECT_ROOT / ".claude" / "skills" / "saraandeva-episode" / "scripts" / "pipeline" / "extractContactSheet.py"
